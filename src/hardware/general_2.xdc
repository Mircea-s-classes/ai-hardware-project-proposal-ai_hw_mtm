...
set_property -dict { PACKAGE_PIN M20   IOSTANDARD LVCMOS33 } [get_ports { POC1 }]; #IO_L7N_T1_AD2N_35 Sch=sw[0]
set_property -dict { PACKAGE_PIN M19   IOSTANDARD LVCMOS33 } [get_ports { POC2 }]; #IO_L7P_T1_AD2P_35 Sch=sw[1]
...
#PMUC STUFF BELOW
#set_property -dict { PACKAGE_PIN T14    IOSTANDARD LVCMOS33} [get_ports PCLK]#io0
#set_property CLOCK_DEDICATED_ROUTE FALSE [get_nets PCLK]
##set_property -dict { PACKAGE_PIN U12    IOSTANDARD LVCMOS33} [get_ports PRESETN] #converted into a switch for simplicity...
#set_property -dict { PACKAGE_PIN U13    IOSTANDARD LVCMOS33 } [get_ports PAD0]
#set_property PULLUP true [get_ports PAD0]
#set_property -dict { PACKAGE_PIN V13    IOSTANDARD LVCMOS33 } [get_ports PAD1]
#set_property PULLUP true [get_ports PAD1]
#set_property -dict { PACKAGE_PIN V15    IOSTANDARD LVCMOS33 } [get_ports PAD2]
#set_property PULLUP true [get_ports PAD2]
#set_property -dict { PACKAGE_PIN T15    IOSTANDARD LVCMOS33 } [get_ports PAD3]
#set_property PULLUP true [get_ports PAD3]
#set_property -dict { PACKAGE_PIN R16    IOSTANDARD LVCMOS33 } [get_ports PAD4]
#set_property PULLUP true [get_ports PAD4]
#set_property -dict { PACKAGE_PIN U17    IOSTANDARD LVCMOS33 } [get_ports PAD5]
#set_property PULLUP true [get_ports PAD5]
#set_property -dict { PACKAGE_PIN V17    IOSTANDARD LVCMOS33 } [get_ports PAD6]
#set_property PULLUP true [get_ports PAD6]
#set_property -dict { PACKAGE_PIN V18    IOSTANDARD LVCMOS33 } [get_ports PAD7]
#set_property PULLUP true [get_ports PAD7]

#SHARED NODEC STUFF BELOW
set_property -dict {PACKAGE_PIN T16 IOSTANDARD LVCMOS33} [get_ports CLK_FAST_IN] #io10
set_property CLOCK_DEDICATED_ROUTE FALSE [get_nets CLK_FAST_IN]
set_property -dict {PACKAGE_PIN R17 IOSTANDARD LVCMOS33} [get_ports CLK_SLOW_IN]#io11
set_property CLOCK_DEDICATED_ROUTE FALSE [get_nets CLK_SLOW_IN]

#NODEC2 STUFF BELOW
set_property -dict {PACKAGE_PIN T14 IOSTANDARD LVCMOS33} [get_ports ISPI0_SCLK_0_2]
set_property PULLUP true [get_ports ISPI0_SCLK_0_2]
set_property -dict {PACKAGE_PIN U13 IOSTANDARD LVCMOS33} [get_ports ISPI0_SDIO_0_2]
set_property PULLUP true [get_ports ISPI0_SDIO_0_2]
set_property -dict {PACKAGE_PIN V13 IOSTANDARD LVCMOS33} [get_ports MISO0_2]
set_property PULLUP true [get_ports MISO0_2]
set_property -dict {PACKAGE_PIN V15 IOSTANDARD LVCMOS33} [get_ports SCLK_sub_2]
set_property PULLUP true [get_ports SCLK_sub_2]
set_property -dict {PACKAGE_PIN T15 IOSTANDARD LVCMOS33} [get_ports MOSI_sub_2]
set_property PULLUP true [get_ports MOSI_sub_2]
set_property -dict {PACKAGE_PIN R16 IOSTANDARD LVCMOS33} [get_ports MISO_sub_2]
set_property PULLUP true [get_ports MISO_sub_2]
set_property -dict {PACKAGE_PIN U17 IOSTANDARD LVCMOS33} [get_ports EXT_CLK_IN_2]
set_property -dict {PACKAGE_PIN V17 IOSTANDARD LVCMOS33} [get_ports GPIO7_2]
set_property PULLUP true [get_ports GPIO7_2]
set_property -dict {PACKAGE_PIN V18 IOSTANDARD LVCMOS33} [get_ports GPIO8_2]
set_property PULLUP true [get_ports GPIO8_2]
...
set_property -dict {PACKAGE_PIN U5 IOSTANDARD LVCMOS33} [get_ports ISPI0_SCLK_0_1]
set_property PULLUP true [get_ports ISPI0_SCLK_0_1]
set_property -dict {PACKAGE_PIN V5 IOSTANDARD LVCMOS33} [get_ports ISPI0_SDIO_0_1]
set_property PULLUP true [get_ports ISPI0_SDIO_0_1]
set_property -dict {PACKAGE_PIN V6 IOSTANDARD LVCMOS33} [get_ports MISO0_1]
set_property PULLUP true [get_ports MISO0_1]
set_property -dict {PACKAGE_PIN U7 IOSTANDARD LVCMOS33} [get_ports SCLK_sub_1]
set_property PULLUP true [get_ports SCLK_sub_1]
set_property -dict {PACKAGE_PIN V7 IOSTANDARD LVCMOS33} [get_ports MOSI_sub_1]
set_property PULLUP true [get_ports MOSI_sub_1]
set_property -dict {PACKAGE_PIN U8 IOSTANDARD LVCMOS33} [get_ports MISO_sub_1]
set_property PULLUP true [get_ports MISO_sub_1]
set_property -dict {PACKAGE_PIN V8 IOSTANDARD LVCMOS33} [get_ports EXT_CLK_IN_1]
set_property -dict {PACKAGE_PIN V10 IOSTANDARD LVCMOS33} [get_ports GPIO7_1]
set_property PULLUP true [get_ports GPIO7_1]
set_property -dict {PACKAGE_PIN W10 IOSTANDARD LVCMOS33} [get_ports GPIO8_1]
set_property PULLUP true [get_ports GPIO8_1]
...
#create_clock -period 40.000 -name PCLK -waveform {0.000 20.000} [get_ports -filter { NAME =~  "*PCLK*" && DIRECTION == "IN" }]
create_clock -period 40.000 -name CLK_FAST_IN -waveform {0.000 20.000} [get_ports -filter { NAME =~  "*CLK_FAST_IN*" && DIRECTION == "IN" }]
create_clock -period 5000.000 -name CLK_SLOW_IN -waveform {0.000 1000.000} [get_ports -filter { NAME =~  "*CLK_SLOW_IN*" && DIRECTION == "IN" }]
