...
set_property -dict { PACKAGE_PIN H16   IOSTANDARD LVCMOS33 } [get_ports { EXT_CLK_IN }]; #IO_L13P_T2_MRCC_35 Sch=sysclk
create_clock -add -name sys_clk_pin -period 8.00 -waveform {0 4} [get_ports { EXT_CLK_IN }];

##Switches

set_property -dict { PACKAGE_PIN M20   IOSTANDARD LVCMOS33 } [get_ports { POC }]; #IO_L7N_T1_AD2N_35 Sch=sw[0]
...
set_property -dict { PACKAGE_PIN T14   IOSTANDARD LVCMOS33 } [get_ports { SDA_global }]; #IO_L5P_T0_34 Sch=ck_io[0]
set_property PULLUP true [get_ports SDA_global]
set_property -dict { PACKAGE_PIN U12   IOSTANDARD LVCMOS33 } [get_ports { SCL_global }]; #IO_L2N_T0_34 Sch=ck_io[1]
set_property PULLUP true [get_ports SCL_global]
#set_property -dict { PACKAGE_PIN U13   IOSTANDARD LVCMOS33 } [get_ports { ck_io[2] }]; #IO_L3P_T0_DQS_PUDC_B_34 Sch=ck_io[2]
set_property -dict { PACKAGE_PIN V13   IOSTANDARD LVCMOS33 } [get_ports { SWCLKTCK }]; #IO_L3N_T0_DQS_34 Sch=ck_io[3]
set_property -dict { PACKAGE_PIN V15   IOSTANDARD LVCMOS33 } [get_ports { SWDIOTMS }]; #IO_L10P_T1_34 Sch=ck_io[4]
set_property -dict { PACKAGE_PIN T15   IOSTANDARD LVCMOS33 } [get_ports { SCL_local }]; #IO_L5N_T0_34 Sch=ck_io[5]
set_property PULLUP true [get_ports SCL_local]
set_property -dict { PACKAGE_PIN R16   IOSTANDARD LVCMOS33 } [get_ports { SDA_local }]; #IO_L19P_T3_34 Sch=ck_io[6]
set_property PULLUP true [get_ports SDA_local]
set_property -dict { PACKAGE_PIN U17   IOSTANDARD LVCMOS33 } [get_ports { GPIO7 }]; #IO_L9N_T1_DQS_34 Sch=ck_io[7]
set_property -dict { PACKAGE_PIN V17   IOSTANDARD LVCMOS33 } [get_ports { GPIO8 }]; #IO_L21P_T3_DQS_34 Sch=ck_io[8]
